...
public class CodeGeneratorDb2 {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/oil?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        */
        ...
        //strategy.setSuperEntityClass("com.lty.fsb.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
        //strategy.setSuperControllerClass("com.lty.fsb.controller.BaseController");
        // 写于父类中的公共字段
